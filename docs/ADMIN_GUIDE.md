...
Ce guide explique comment utiliser le panneau d'administration pour gérer le site UrgenceGabon.com.
...
2. Choisissez le type de service :
   ...
   - Protection Civile
   - Autre
3. Renseignez le libellé (ex: "Hôpital Régional de Franceville")
